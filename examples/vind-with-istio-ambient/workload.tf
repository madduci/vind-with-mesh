...
resource "terraform_data" "install_example" {
  depends_on = [kubernetes_namespace_v1.workshop, terraform_data.install_gateway]
  input = {
...
# Wait for the cluster to be ready
resource "terraform_data" "remove_example" {
